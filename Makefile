...
baby:
	$(CROSS_COMPILE) $(CFLAGS) $(BBG_HW_LIB_SRC_FILE) $(BABY_MONITOR_SYS_LIB_SRC_FILE) $(BABY_MONITOR_MICROPHONE_SRC_FILE) $(BABY_MONITOR_SRC_FILE) $(DEBUG_MODE) $(DEMO_MODE) -o $(BABY_MONITOR_BABY_OBJ_FILE) $(LFLAGS)
