...
captureVideo:
	$(CROSS_COMPILE) $(BABY_MONITOR_VIDEO_DIR)/$(BABY_MONITOR_VIDEO_CAPTURE_SRC_FILE) -o $(BABY_MONITOR_VIDEO_DIR)/$(BABY_MONITOR_VIDEO_CAPTURE_OBJ_FILE) $(LFLAGS_VIDEO)
...
clean:
	...
	rm -r $(NFS_PATH)/$(BABY_MONITOR_VIDEO_DIR)/$(BABY_MONITOR_VIDEO_CAPTURE_OBJ_FILE)
